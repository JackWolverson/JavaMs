    ...
    public static msgServer.Command getCommand(BufferedReader in,
        ...
        try {
            ...
            switch (command) {
                ...
                case MsgProtocol.SET_REMINTER: //107
                	return new SetReminderCommand(in, out, serverConn);
                case MsgProtocol.REGISTER: //108
                    return new RegisterCommand(in, out, serverConn);
                case MsgProtocol.UPDATE_DETAILS: //109
                	return new UpdateDetailsCommand(in, out, serverConn);
                case MsgProtocol.UPDATE_REMINDER: //110
